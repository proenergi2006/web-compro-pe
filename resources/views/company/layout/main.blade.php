...
<head>
    ...
    <title>@yield('title', 'Pro Energi - Energy Service & Solution')</title>
                        ...
                        <div class="offcanvas-gallery-thumb-wrapper">
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="{{ asset('assets/images/gallery/gallery-thumb-01.png')}}">
                                    <img src="{{ asset('assets/images/gallery/gallery-thumb-01.png')}}" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="{{ asset('assets/images/gallery/gallery-thumb-02.png')}}">
                                    <img src="{{ asset('assets/images/gallery/gallery-thumb-02.png')}}" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="{{ asset('assets/images/gallery/gallery-thumb-03.png')}}">
                                    <img src="{{ asset('assets/images/gallery/gallery-thumb-03.png')}}" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="{{ asset('assets/images/gallery/gallery-thumb-04.png')}}">
                                    <img src="{{ asset('assets/images/gallery/gallery-thumb-04.png')}}" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="{{ asset('assets/images/gallery/gallery-thumb-05.png')}}">
                                    <img src="{{ asset('assets/images/gallery/gallery-thumb-05.png')}}" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="{{ asset('assets/images/gallery/gallery-thumb-01.png')}}">
