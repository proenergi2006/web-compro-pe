    ...
    {{-- <footer class="rs-footer-area rs-footer-one white-bg"> --}}
        <div class="rs-footer-copyright-area rs-copyright-one has-theme-deep-blue">
            <div class="container">
                <div class="d-flex row justify-content-center">
                    <div class="col-xl-12">
                        <div class="rs-footer-copyright d-flex justify-content-between align-items-center">
                            <div class="rs-copy ">
                                © 2025 PT ProEnergi. All Rights Reserved.
                            </div>
                            <p class="mb-0">
        ...
        {{-- <div class="rs-footer-copyright-area rs-copyright-one" style="background: lightgray">
            <div class="container">
