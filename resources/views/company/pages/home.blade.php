       ...
       <!-- banner area start -->
        {{-- <section class="rs-banner-area rs-banner-one p-relative rs-swiper">
            <div class="rs-banner-shape">
                <img src="{{ asset('assets/images/shape/half-arrow.png')}}" alt="image">
            </div>
            <div class="container">
            ...
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="fade" data-delay="1000" data-item="1" data-item-xl="1" data-item-lg="1" data-item-md="1" data-item-sm="1" data-item-xs="1" data-item-mobile="1" data-margin="30" data-margin-xl="30" data-margin-lg="30" data-margin-md="30" data-margin-sm="30" data-margin-xs="30" data-margin-mobile="30">
                    <div class="swiper-wrapper">
                                        ...
                                        <div class="col-xxl-8 col-xl-8 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    <h1 class="rs-banner-title">Leader in industrial Factory around <br> the world
                                                    </h1>
                                                    ...
                                                    <div class="rs-banner-info-btn">
                                                        <div class="rs-banner-btn">
                                                            <a class="rs-btn has-theme-orange has-icon has-bg" href="contact.html">Explore More
                                                                <span class="icon-box">
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="{{ asset('assets/images/bg/banner-bg-02.png')}}">
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xxl-8 col-xl-8 col-lg-10">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    <h1 class="rs-banner-title">Moving Your Industry Manufacturing <br> Forward </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>We face each project as a new challenge and with our ability to build and
                                                            innovate we overcome all barriers to using content. </p>
                                                    </div>
        ...
        <section class="rs-banner-area rs-banner-five p-relative rs-swiper">
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="fade" data-delay="3000" data-item="1" data-margin="30" data-margin-xl="30" data-margin-lg="30" data-margin-md="30" data-margin-sm="30" data-margin-xs="30" data-margin-mobile="30">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="{{ asset('assets/images/pe-bg/10.jpg')}}">
                                            ...
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    <span class="rs-banner-subtitle">
                                                        Energy Service & Solution
                                                    </span>
                                                    <h1 class="rs-banner-title">Energy Service & Solution
                                                    </h1>
                                                    <div class="rs-banner-btn">
                                                        <a class="rs-btn has-theme-orange has-icon has-bg" href="contact.html">Learn More
                                                            <span class="icon-box">
                                                <svg class="icon-first" xmlns="http://www.w3.org/2000/svg"
                                                   viewBox="0 0 32 32">
                                                   <path
                                        ...
                                        <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-9">
                                            <div class="rs-banner-item">
                                                <div class="rs-banner-content">
                                                    ...
                                                    <h1 class="rs-banner-title">We Help to Build your Dream
                                                    </h1>
                                                    <div class="rs-banner-descrip">
                                                        <p>Our vans are fitted with high pressure jetting units which will clear
                                                            blocked drain safely, easily and professionally. </p>
                                                    </div>
                                                    <div class="rs-banner-btn">
                                                        <a class="rs-btn has-theme-orange has-icon has-bg" href="contact.html">Contact
                                                            Us
                                                            <span class="icon-box">
                                                <svg class="icon-first" xmlns="http://www.w3.org/2000/svg"
                                                   viewBox="0 0 32 32">
                    ...
                    <!-- If we need navigation buttons -->
                    <div class="rs-banner-navigation">
                        <button class="swiper-button-prev rs-swiper-btn"><i class="fa-sharp fa-regular fa-chevron-left"></i></button>
                        <button class="swiper-button-next rs-swiper-btn"><i class="fa-sharp fa-regular fa-chevron-right"></i></button>
                    </div>
                    <!-- if we need pagination -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-feature-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="rs-feature-descrip">
                                <p>The printing and typesetting industry. Lorem Ipsum has been the industry's standard. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
        ...
        <!-- counter area start -->
        {{-- <div class="rs-counter-area rs-counter-one section-space-bottom">
            <div class="container">
                <div class="row g-5">
        ...
        <div class="rs-video-area section-space-medium rs-video-three jarallax">
            ...
            <div class="container justify-content-between">
                <div class="row text-center">
                    <h2 class="rs-video-title">Our Product</h2>
                </div>
                <div class="row">
