...
@section('content')
                                ...
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-7">
                                            <div class="rs-banner-wrapper">
                                                <div class="rs-banner-content">
                                                    <h1 class="rs-banner-title" style="background: rgb(255, 165, 0);display: inline-block;padding: 9px 10px;">{{ __('message.committed') }}
                                                    </h1>
        ...
        {{-- about blue start --}}
        <section class="rs-elements-portfolio-area section-space rs-portfolio-eight rs-swiper">
            <div class="container">
                <div class="row justify-content-center">
                            ...
                            <div class="rs-portfolio-item">
                                <div class="rs-portfolio-thumb wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                    <a href="{{ asset('assets/images/about/MG_4899.jpg')}}" data-pswp-width="1200" data-pswp-height="900" target="_blank">
                                        <img src="{{ asset('assets/images/about/MG_4899.jpg')}}" data-pswp-width="1200" data-pswp-height="900" target="_blank" alt="image">
                                    </a>
                                </div>
        ...
        <div class="rs-video-area section-space-medium rs-video-three jarallax">
            ...
            <div class="container justify-content-between">
                <div class="row text-center">
                    <h2 class="rs-video-title rs-split-text-enable split-in-fade">{{ __('message.ourproduct') }}</h2>
                </div>
                <div class="row">
        ...
        <!-- video area end -->
        <section class="rs-contact-area section-space rs-contact-three">
            <div class="container">
        ...
        <!-- testimonial area start -->
         ...
         <!-- blog Style 02 -->
        <section class="rs-elements-blog-area section-space rs-blog-two rs-swiper">
            <div class="container">
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-7 col-xl-8 col-lg-8">
                        <div class="text-center has-theme-red">
